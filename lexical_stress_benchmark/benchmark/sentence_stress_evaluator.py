...
# https://github.com/lang-uk/ukrainian-word-stress/blob/main/ukrainian_word_stress/data/stress.trie
...
def evaluate_stress_sentence_level(
    ...
    candidate_sentence = candidate_sentence.strip().lower()
    ...
    for correct_word, candidate_word in zip(correct_words, candidate_words):
        ...
        # else:
        #     if is_unambiguous:
        #         print(f"\nCorrect: {correct_word}, Retrieved: {candidate_word}")
...
if __name__ == "__main__":
    ...
    correct = "при+віт"
    candidate = "при+ві+т"
    print(evaluate_stress_word_level(correct, candidate))